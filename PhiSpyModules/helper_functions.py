...
<<<<<<< HEAD
    ...
    parser.add_argument('--kmers_file', default=os.path.join(os.path.dirname(__file__), 'data', 'phage_kmers_all_wohost.txt'), type=str,
                             help='Path to phage-specific kmers. [Default: data\' kmer file]')
    parser.add_argument('--kmer_size', default=12, type=int,
                             help='Kmer size used for making training sets. [Default: 12]')
=======
...
<<<<<<< HEAD
    ...
    print(os.path.join(os.path.dirname(__file__), 'data', 'phage_kmers_all_wohost.txt'))
